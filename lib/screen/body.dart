          ...
          children: <Widget>[
                                    ...
                                    children: <Widget>[
                                      (checker.country?.countryFlag ==
                                          ...
                                          : Image.asset(
                                            ...
                                            (checker.country?.countryName == null)?Text(
                                          'Global',
                                          style: TextStyle(
                                              color: Colors.black87,
                                              fontSize: 18,
            ...
            SizedBox(
                ...
                child: PageView(
                  children: <Widget>[
                    FutureBuilder(
                      future: sl.get<ApiData>().getAllCountryData(),
                      builder: (BuildContext context,
                          AsyncSnapshot<dynamic> snapshot) {
                        if (snapshot.hasData) {
                          return Row(
                            children: <Widget>[
                              Expanded(
                                  flex: 2,
                                  child: _buildcolum('Country', 10)),
                              Expanded(
                                  child:
                                      _buildcolum2('Confirmed', 10)),
                              Expanded(
                                  child:
                                      _buildcolum3('Recovered', 10)),
                              Expanded(
                                  child: _buildcolum4('Deaths', 10)),
